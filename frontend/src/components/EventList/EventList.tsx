...
const EventList: React.FC = () => {
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                ...
                const response = await fetch(`http://api.localhost/api/eventos/publicos/${userId}`);
    ...
    const participarEvento = async (eventoId: number) => {
        ...
        try {
            const response = await fetch(`http://api.localhost/api/eventos/${eventoId}/participar`, {
                method: 'POST',
                headers: {
